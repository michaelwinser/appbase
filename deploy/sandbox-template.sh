...
# Generated by: appbase sandbox-template
#
# Customize the --allow, --read, and --allow-bind flags below for your project.
...
APP_FLAGS=""
# APP_FLAGS="$APP_FLAGS --allow $HOME/.config/myapp"    # App data directory
# APP_FLAGS="$APP_FLAGS --allow-bind 3000"               # Dev server port
